...
STREET_ADDRESS = "119/6, Mile Stone, GT Road, Opp to Neelkanth Dhaba, Daha Madanpur Village, Near Namastey Chowk"
...
<section class="section advantage-section"><div class="container"><div class="advantage-intro"><div><p class="eyebrow">UrbanFresh versus weak offers</p><h2 class="section-title">Stop buying rice on promises. Buy against proof.</h2></div><div><p class="section-lede">A low price cannot rescue an unclear mill source, vague specification or unsupported compliance claim. UrbanFresh puts the production facility, buying brief and evidence questions in front of the buyer before commitment.</p><a class="button button-gold" href="contact.html#rfq">Send a serious RFQ</a><p><a class="text-link" href="client-proof.html">Watch factory and client-loading proof</a></p></div></div><div class="advantage-grid" role="table" aria-label="UrbanFresh compared with weak rice sourcing offers"><div class="advantage-row advantage-head" role="row"><span role="columnheader">Decision point</span><strong role="columnheader">The UrbanFresh advantage</strong><span role="columnheader">What a weak offer looks like</span></div><div class="advantage-row" role="row"><span role="rowheader">Mill source</span><strong role="cell">A named Karnal production facility with first-party mill photography and video.</strong><span role="cell">The actual processing source remains hidden behind a catalogue or trader.</span></div><div class="advantage-row" role="row"><span role="rowheader">Automation</span><strong role="cell">Fully automated production facility.</strong><span role="cell">More manual and disconnected handling can increase process uncertainty.</span></div><div class="advantage-row" role="row"><span role="rowheader">U.S. FDA</span><strong role="cell">U.S. FDA registration is listed among our available mill records, with current copies open to buyer verification.</strong><span role="cell">No current registration or operating-entity record is shown for verification.</span></div><div class="advantage-row" role="row"><span role="rowheader">Export support</span><strong role="cell">Export-friendly buyer support for destination, quality-evidence, packing and document requirements.</strong><span role="cell">Limited export support can leave critical destination requirements unresolved.</span></div><div class="advantage-row" role="row"><span role="rowheader">Specification</span><strong role="cell">Rice, crop, process, limits, pack and volume defined before acceptance.</strong><span role="cell">“Export quality” is used as a substitute for measurable requirements.</span></div><div class="advantage-row" role="row"><span role="rowheader">Evidence</span><strong role="cell">Factory and client-loading footage shown. Lot-specific evidence reviewed against the destination brief.</strong><span role="cell">Old or generic reports are presented without tying them to the offered lot.</span></div><div class="advantage-row" role="row"><span role="rowheader">Packing</span><strong role="cell">Pack, artwork and loading inputs are reviewed before confirmation.</strong><span role="cell">Container figures are guessed before the bag and loading method are fixed.</span></div></div></div></section>
...
""",
    ...
    {
        "slug": "client-proof.html",
        "nav": "Client proof",
        "title": "Factory and Client Loading Videos | UrbanFresh",
...
def header(active: str) -> str:
    ...
    return f"""
<div class="topbar"><div class="container topbar-inner"><span>Fully automated production facility · Rajesh Industries · Karnal, India</span><span><a href="{EMAIL_LINK}">Email us</a> · <a href="tel:{PHONE_LINK}">{PHONE_DISPLAY}</a></span></div></div>
...
<footer class="site-footer"><div class="container footer-grid">
  <div><a class="brand" href="/"><img src="assets/images/urbanfresh-logo.webp" width="48" height="48" alt=""><span class="brand-copy"><span class="brand-name">UrbanFresh</span><span class="brand-tag">International buyer desk</span></span></a><p>The mill is operated under the legal name {LEGAL_ENTITY}; UrbanFresh is the customer-facing brand. Established in 1978, we serve international buyers from Karnal, India. {AUTOMATION_CLAIM} Specifications, evidence, packing and terms are confirmed per enquiry.</p></div>
  <div><h2 class="footer-title">Buyer journey</h2><div class="footer-links"><a href="about-mill-infrastructure.html">Mill & infrastructure</a><a href="client-proof.html">Client proof videos</a><a href="quality-residue-testing.html">Quality & MRL review</a><a href="export-documents.html">Export documents</a><a href="packing-container-logistics.html">Packing & containers</a></div></div>
  ...
  <div><h2 class="footer-title">Contact</h2><div class="footer-links"><span>{LEGAL_ENTITY}</span><span>119/6, Mile Stone, GT Road</span><span>Opp to Neelkanth Dhaba</span><span>Daha Madanpur Village, Near Namastey Chowk</span><span>Karnal, Haryana - 132001, India</span><a href="{EMAIL_LINK}">{CONTACT_EMAIL}</a><a href="contact.html#rfq">International RFQ form</a><a href="{WHATSAPP}" target="_blank" rel="noopener">WhatsApp buyer desk</a><a href="tel:{PHONE_LINK}">{PHONE_DISPLAY}</a><a href="https://urbanfresh.in/" rel="external">Domestic India sales: urbanfresh.in</a><a href="{LINKEDIN}" target="_blank" rel="noopener noreferrer">LinkedIn</a></div></div>
...
<body class="{"page-thank-you" if slug == "thank-you.html" else ""}">
  ...
  {footer()}
  <script src="assets/js/site.js?v=20260725-2" defer></script>
</body>
</html>
"""
